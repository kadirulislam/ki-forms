  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "data-[state=checked]:bg-[--studio-accent] data-[state=unchecked]:bg-input",
        className,
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block size-4 rounded-full bg-background ring-0 shadow transition-transform",
